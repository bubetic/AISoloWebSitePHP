	...
	<div class="formWrapper">
		<form id="registerForm" onsubmit="event.preventDefault(); register();">
			...
			<div class="inputblock">
				...
				<input id="password" name="password" type="password" autocomplete="new-password" placeholder="Enter your password" />
			</div>
			<div class="inputblock">
				<label for="confirm-password">Confirm Password</label>
				<input id="confirm-password" name="confirm-password" type="password" autocomplete="new-password" placeholder="Confirm your password" />
			</div>
			<br>
			<button type="button" class="btn" onclick="register();">Sign Up</button>
			<br>
			<br>
			<br>
